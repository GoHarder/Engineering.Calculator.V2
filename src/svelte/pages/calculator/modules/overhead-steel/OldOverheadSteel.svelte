...
<Dialog bind:show={templateDialog} fullScreen>
   ...
   <ImageList textProtection>
      <ImageListItem on:click={() => (templateDialog = false)} alt="Test Image" label="Image Label" select src="https://picsum.photos/500?random=1" />
      <ImageListItem on:click={() => (templateDialog = false)} alt="Test Image" label="Image Label" select src="https://picsum.photos/500?random=2" />
      <ImageListItem on:click={() => (templateDialog = false)} alt="Test Image" label="Image Label" select src="https://picsum.photos/500?random=3" />
      <ImageListItem on:click={() => (templateDialog = false)} alt="Test Image" label="Image Label" select src="https://picsum.photos/500?random=4" />
      <ImageListItem on:click={() => (templateDialog = false)} alt="Test Image" label="Image Label" select src="https://picsum.photos/500?random=5" />
      <ImageListItem on:click={() => (templateDialog = false)} alt="Test Image" label="Image Label" select src="https://picsum.photos/500?random=6" />
      <ImageListItem on:click={() => (templateDialog = false)} alt="Test Image" label="Image Label" select src="https://picsum.photos/500?random=7" />
   </ImageList>
