...
export const getChannels = (supplied, shape) => {
   ...
   return [
      ...
      { $project: { area: 0, flangeWidth: 0, gage: 0, inertiaY: 0, material: 0, modulusY: 0, webThickness: 0, shape: 0 } },
   ];
};
...
export const getBeams = (supplied, shape) => {
   ...
   return [
      ...
      { $sort: sortStep },
      { $unset: ['_nameSort', '_specialSort', '_stockStatusSort'] },
      { $project: { area: 0, flangeWidth: 0, gage: 0, inertiaY: 0, material: 0, maxLength: 0, modulusY: 0, shape: 0, webThickness: 0 } },
   ];
};
